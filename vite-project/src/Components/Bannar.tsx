...
const Bannar = () => {
  return (
    <section className="w-[82.4375rem] h-[37.5rem] mx-[18.75rem] my-[1.5rem] flex gap-[24px]  ">
      <div className="w-[54.5rem] h-[37.5rem]">
        <img
          src={banner1}
          alt=""
          className="w-[54.5rem] h-[37.5rem] rounded-lg bg-gradient-to-r from-green-950 to-green-400 absolute"
        />
        <div className="w-[37.25rem] h-[18.125rem] relative top-[9.6875rem] left-[3.75rem] gap-[1.75rem] ">
          <h1 className="font-semibold text-5xl text-[#FFFFFF]">
            {" "}
          ...
          <div className="border-l-2 pl-[0.75rem] my-[1.75rem] ">
            <div className="  flex gap-[0.5rem] text-[#FFFFFF]">
              ...
              <span className="font-semibold text-xl  bg-[#FF8A00] px-[0.75rem] py-[0.25rem] rounded-md">
                30% OFF
              </span>
            </div>
            <p className="font-normal text-base mt-[0.5rem] text-[#808080] ">
      ...
      <div className="grid grid-rows-2  gap-[1.5rem] mr-[1.5rem]">
        <div>
          ...
          <div className="h-[8.5rem] w-[9.75rem]  relative top-[2rem] left-[2rem]">
            ...
            <p className="font-normal text-sm pt-[0.75rem] text-[#666666]">
        ...
        <div>
          <img
            src={banner3}
            alt=""
            className="h-[18rem] w-[26.4375rem] absolute"
          />
